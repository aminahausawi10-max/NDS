...
const dictionary = {
  en: {
    ...
    'stat-auth': 'MOFA Authentication', 'stat-auth-desc': 'Secure document legalization and embassy authorization.',
  ...
  ha: { // Hausa Translations
    ...
    'stat-auth': 'Halaccin MOFA', 'stat-auth-desc': 'Tabbatar da takardu a ma\'aikatar harkokin waje.',
  ...
  ar: { // Arabic Translations
    ...
    'stat-auth': 'تصديقات وزارة الخارجية', 'stat-auth-desc': 'تقنين المستندات قانونياً واعتماد السفارات.',
  ...
  fr: { // French Translations
    ...
    'stat-auth': 'Légalisation MOFA', 'stat-auth-desc': 'Légalisation sécurisée des documents et visa de l\'ambassade.',
